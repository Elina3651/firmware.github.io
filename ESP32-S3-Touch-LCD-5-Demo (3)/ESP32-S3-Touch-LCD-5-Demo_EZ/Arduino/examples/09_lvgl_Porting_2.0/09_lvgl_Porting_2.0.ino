...
lv_obj_t* label_edit_thermal_enable;
lv_obj_t* label_edit_heat_hold;
lv_obj_t* label_edit_temp;
lv_obj_t* label_edit_nitrogen;
lv_obj_t* label_edit_cooling;
lv_obj_t* label_edit_primary_uv;
lv_obj_t* label_edit_secondary_uv;
lv_obj_t* label_edit_type1_primary; // Для "Type 1" в секции Primary
lv_obj_t* label_edit_type2_primary; // Для "Type 2" в секции Primary
lv_obj_t* label_edit_flickers1;
lv_obj_t* label_edit_flickers2;
lv_obj_t* label_edit_type1_secondary; // Для "Type 1" в секции Secondary
lv_obj_t* label_edit_type2_secondary; // Для "Type 2" в секции Secondary
lv_obj_t* label_edit_btn_save;
lv_obj_t* label_edit_btn_cancel;
...
static void profile_detail_start_event_cb(lv_event_t * e) {
    ...
    params["primary_uv_type1_enabled"] = current_active_profile_data.primary_uv_type1_enabled;
    params["primary_uv_type1_flickers"] = current_active_profile_data.primary_uv_type1_flickers;
    params["primary_uv_type2_enabled"] = current_active_profile_data.primary_uv_type2_enabled;
    params["primary_uv_type2_flickers"] = current_active_profile_data.primary_uv_type2_flickers;
    params["secondary_uv_exposure_sec"] = current_active_profile_data.secondary_uv_exposure_sec;
    params["secondary_uv_type1_enabled"] = current_active_profile_data.secondary_uv_type1_enabled;
    params["secondary_uv_type2_enabled"] = current_active_profile_data.secondary_uv_type2_enabled;
    ...
    if (code == LV_EVENT_CLICKED) {
        ...
        if (read_ok && parseProfileJson(file_content_buffer, current_active_profile_data)) {
            ...
            if (current_global_settings.language == 1) { // RUS
                ...
                if (label_detail_view_nitrogen) lv_label_set_text_fmt(label_detail_view_nitrogen, "Азот: %s", current_active_profile_data.nitrogen_use_enabled ? on_str : off_str);
                ...
                if (label_detail_view_nitrogen) lv_label_set_text_fmt(label_detail_view_nitrogen, "Nitrogen Use: %s", current_active_profile_data.nitrogen_use_enabled ? on_str : off_str);
...
static void profile_detail_edit_btn_event_cb(lv_event_t * e) {
    ...
    if (code == LV_EVENT_CLICKED) {
        ...
        if (screen_profile_edit) {
            ...
            // --- ДОБАВЛЕННЫЙ БЛОК ПЕРЕВОДА ---
            if (current_global_settings.language == 1) { // RUS
                lv_label_set_text(label_edit_name_title, "Имя:");
                lv_label_set_text(label_edit_thermal_enable, "Термокамера:");
                lv_label_set_text(label_edit_heat_hold, "Удержание (с):");
                lv_label_set_text(label_edit_temp, "Температура (C): ");
                lv_label_set_text(label_edit_nitrogen, "Азот:");
                lv_label_set_text(label_edit_cooling, "Сжатый воздух:");
                lv_label_set_text(label_edit_primary_uv, "Мерцания УФ (с):");
                lv_label_set_text(label_edit_secondary_uv, "Статичный УФ (с):");
                lv_label_set_text(label_edit_type1_primary, "Тип 1");
                lv_label_set_text(label_edit_type2_primary, "Тип 2");
                lv_label_set_text(label_edit_flickers1, "частота:");
                lv_label_set_text(label_edit_flickers2, "частота:");
                lv_label_set_text(label_edit_type1_secondary, "Тип 1");
                lv_label_set_text(label_edit_type2_secondary, "Тип 2");
                lv_label_set_text(label_edit_btn_save, "Сохранить");
                lv_label_set_text(label_edit_btn_cancel, "Отмена");
            } else { // ENG
                lv_label_set_text(label_edit_name_title, "Name:");
                lv_label_set_text(label_edit_thermal_enable, "Thermal Chamber:");
                lv_label_set_text(label_edit_heat_hold, "Hold (s):");
                lv_label_set_text(label_edit_temp, "Temp (C): ");
                lv_label_set_text(label_edit_nitrogen, "Nitrogen Use:");
                lv_label_set_text(label_edit_cooling, "Compressed Air:");
                lv_label_set_text(label_edit_primary_uv, "Primary UV (s):");
                lv_label_set_text(label_edit_secondary_uv, "Secondary UV (s):");
                lv_label_set_text(label_edit_type1_primary, "Type 1");
                lv_label_set_text(label_edit_type2_primary, "Type 2");
                lv_label_set_text(label_edit_flickers1, "flickers:");
                lv_label_set_text(label_edit_flickers2, "flickers:");
                lv_label_set_text(label_edit_type1_secondary, "Type 1");
                lv_label_set_text(label_edit_type2_secondary, "Type 2");
                lv_label_set_text(label_edit_btn_save, "Save Changes");
                lv_label_set_text(label_edit_btn_cancel, "Cancel Edit");
            }
...
static void build_profile_edit_screen(lv_obj_t* parent_screen) {
    Serial.println("Building profile_edit_screen UI (Final Clean Version with Translation Hooks)...");
    ...
    lv_obj_set_style_pad_row(main_container, 8, 0);
    ...
    lv_obj_set_style_border_width(block1_id_name, 0, 0);
    ...
    lv_obj_add_style(label_id_title, &style_my_text_18, 0);
    label_edit_profile_id_val = lv_label_create(block1_id_name);
    lv_label_set_text(label_edit_profile_id_val, "--");
    lv_obj_add_style(label_edit_profile_id_val, &style_my_text_18, 0);
    
    label_edit_name_title = lv_label_create(block1_id_name);
    lv_label_set_text(label_edit_name_title, "Name:");
    ...
    lv_obj_add_style(lv_textarea_get_label(ta_edit_profile_name), &style_just_font_18, 0);
    ...
    lv_obj_set_style_border_width(block2_thermal, 0, 0);
    lv_obj_set_style_pad_all(block2_thermal, 10, 0);

    label_edit_thermal_enable = lv_label_create(block2_thermal);
    lv_label_set_text(label_edit_thermal_enable, "Thermal Chamber:");
    lv_obj_add_style(label_edit_thermal_enable, &style_my_text_18, 0);
    ...
    label_edit_heat_hold = lv_label_create(heat_hold_elements_container);
    lv_label_set_text(label_edit_heat_hold, "Hold(30-180s):");
    lv_obj_add_style(label_edit_heat_hold, &style_my_text_18, 0);
    ...
    lv_obj_add_style(lv_textarea_get_label(ta_edit_heat_hold), &style_just_font_18, 0);
    ...
    label_edit_temp = lv_label_create(temp_col);
    lv_label_set_text(label_edit_temp, "Temp(40-80C): ");
    lv_obj_add_style(label_edit_temp, &style_my_text_18, 0);
    ...
    lv_obj_add_style(label_edit_thermal_temp_val, &style_my_text_18, 0);
    ...
    lv_obj_set_style_border_width(block3_gases, 0, 0);
    ...
    label_edit_nitrogen = lv_label_create(gas_left_col);
    lv_label_set_text(label_edit_nitrogen, "Nitrogen Use:");
    lv_obj_add_style(label_edit_nitrogen, &style_my_text_18, 0);
    sw_edit_nitrogen = lv_switch_create(gas_left_col);
    ...
    label_edit_cooling = lv_label_create(gas_right_col);
    lv_label_set_text(label_edit_cooling, "Chamber Cooling:");
    lv_obj_add_style(label_edit_cooling, &style_my_text_18, 0);
    sw_edit_chamber_cooling = lv_switch_create(gas_right_col);
    ...
    lv_obj_set_style_border_width(block4_uv, 0, 0);
    ...
    { // Наполняем левую колонку UV (Primary)
        ...
        label_edit_primary_uv = lv_label_create(row_time);
        lv_label_set_text(label_edit_primary_uv, "Primary UV (5-60s):");
        lv_obj_add_style(label_edit_primary_uv, &style_my_text_18, 0);
        ...
        lv_obj_set_size(ta_edit_primary_uv, 60, lv_pct(100)); lv_obj_set_scrollbar_mode(ta_edit_primary_uv, LV_SCROLLBAR_MODE_OFF); lv_obj_add_style(lv_textarea_get_label(ta_edit_primary_uv), &style_just_font_18, 0);
        ...
        lv_obj_clear_flag(row_type1, LV_OBJ_FLAG_SCROLLABLE);
        ...
        label_edit_type1_primary = lv_label_create(row_type1);
        lv_label_set_text(label_edit_type1_primary, "Type 1");
        lv_obj_set_width(label_edit_type1_primary, 70);
        lv_obj_add_style(label_edit_type1_primary, &style_my_text_18, 0);
        ...
        label_edit_flickers1 = lv_label_create(row_type1);
        lv_label_set_text(label_edit_flickers1, "flickers:");
        lv_obj_add_style(label_edit_flickers1, &style_my_text_18, 0);
        lv_obj_t* spacer_flicker1 = lv_obj_create(row_type1); lv_obj_remove_style_all(spacer_flicker1); lv_obj_set_width(spacer_flicker1, 2); 
        ...
        lv_obj_set_style_pad_left(label_primary_uv_type1_val, 5, 0); lv_obj_add_style(label_primary_uv_type1_val, &style_my_text_18, 0); lv_obj_set_style_text_align(label_primary_uv_type1_val, LV_TEXT_ALIGN_CENTER, 0);
        ...
        lv_obj_clear_flag(row_type2, LV_OBJ_FLAG_SCROLLABLE);
        ...
        label_edit_type2_primary = lv_label_create(row_type2);
        lv_label_set_text(label_edit_type2_primary, "Type 2");
        lv_obj_set_width(label_edit_type2_primary, 70);
        lv_obj_add_style(label_edit_type2_primary, &style_my_text_18, 0);
        ...
        label_edit_flickers2 = lv_label_create(row_type2);
        lv_label_set_text(label_edit_flickers2, "flickers:");
        lv_obj_add_style(label_edit_flickers2, &style_my_text_18, 0);
        lv_obj_t* spacer_flicker2 = lv_obj_create(row_type2); lv_obj_remove_style_all(spacer_flicker2); lv_obj_set_width(spacer_flicker2, 2); 
        ...
        lv_obj_set_style_pad_left(label_primary_uv_type2_val, 5, 0); lv_obj_add_style(label_primary_uv_type2_val, &style_my_text_18, 0); lv_obj_set_style_text_align(label_primary_uv_type2_val, LV_TEXT_ALIGN_CENTER, 0);
    }
    { // Наполняем правую колонку UV (Secondary)
        ...
        label_edit_secondary_uv = lv_label_create(row);
        lv_label_set_text(label_edit_secondary_uv, "Secondary UV (5-200s):");
        lv_obj_add_style(label_edit_secondary_uv, &style_my_text_18, 0);
        ...
        lv_obj_set_size(ta_edit_secondary_uv, 70, lv_pct(100)); lv_obj_set_scrollbar_mode(ta_edit_secondary_uv, LV_SCROLLBAR_MODE_OFF); lv_obj_add_style(lv_textarea_get_label(ta_edit_secondary_uv), &style_just_font_18, 0);
        ...
        label_edit_type1_secondary = lv_label_create(row);
        lv_label_set_text(label_edit_type1_secondary, "Type 1");
        lv_obj_set_width(label_edit_type1_secondary, 70);
        lv_obj_add_style(label_edit_type1_secondary, &style_my_text_18, 0);
        ...
        label_edit_type2_secondary = lv_label_create(row);
        lv_label_set_text(label_edit_type2_secondary, "Type 2");
        lv_obj_set_width(label_edit_type2_secondary, 70);
        lv_obj_add_style(label_edit_type2_secondary, &style_my_text_18, 0);
    ...
    lv_obj_set_style_border_width(block5_buttons, 0, 0);
    ...
    label_edit_btn_save = lv_label_create(btn_save_changes);
    lv_label_set_text(label_edit_btn_save, "Save Changes");
    lv_obj_add_style(label_edit_btn_save, &style_my_text_18_white, 0);
    lv_obj_center(label_edit_btn_save);
    ...
    label_edit_btn_cancel = lv_label_create(btn_cancel_edit);
    lv_label_set_text(label_edit_btn_cancel, "Cancel Edit");
    lv_obj_add_style(label_edit_btn_cancel, &style_my_text_18_white, 0);
    lv_obj_center(label_edit_btn_cancel);
